...
/*		array (
	...
	//	array (																		
	//	'value'   	=> 'HoughAndCo/images/uploaded/',												
	//		'text'    	=> 'Site Images',
	//	),
	//	array (
	//		'value'   	=> 'HoughAndCo/images/uploaded/properties/', 				
	...
	$cfg['ilibs_dir'] 	   = array('HoughAndCo/public/images/uploaded/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
