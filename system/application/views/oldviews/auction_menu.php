		<ul class="nav" id="nav">
			...
			<li class="pink estate"><a href="<?=site_url()?>/auction-services"><span><strong><em>estate<br/> agents</em></strong></span></a></li>
			<li class="pink"><a href="<?=site_url()?>/auction-services/estate-agents"><span><strong><em>catalogue<br/> of properties</em></strong></span></a></li>
